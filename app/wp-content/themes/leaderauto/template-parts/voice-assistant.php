...
<section class="section section--surface voice" id="voice-assistant">
	<div class="section__inner voice__inner">
		<div class="voice__text">
			...
			<p><?php esc_html_e( 'Поговоріть з нашим голосовим ШІ-асистентом просто з браузера. Він розповість про послуги та відповість на типові запитання, а в робочий час на вас чекають майстри за телефоном вище.', 'leaderauto' ); ?></p>
